...
class FinTechSpider(Spider):
	...
	start_urls=[('news','http://news.discuss.com.hk/forumdisplay.php?fid=54')
					]
	...
	def start_requests(self):
		...
		for url in self.start_urls:
			yield scrapy.Request(url=url[1], callback=self.parse,meta={'category':url[0]})
